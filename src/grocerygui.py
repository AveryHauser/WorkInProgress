...
class GroceryApp:
    def __init__(self, root, db_config):
        self.root = root
        self.db_config = db_config  # Save config passed from main.py
        ...
        tk.Label(root, text="Grocery Store Manager & Analytics", font=("Arial", 14, "bold")).pack(pady=20)
    ...
    def connect_db(self):
        try:
            # Use the instance variable self.db_config
